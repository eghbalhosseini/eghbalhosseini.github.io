...
\textbf{Selected}\
\vspace{2mm} \\
Zach Cohen$^\ast$, Akshay K Jagadish$^\ast$, \textbf{Eghbal A Hosseini}$^\ast$\footnote{$^\ast$ Equal contribution; author order randomized}, Maria K Eckstein. 2026. ``Reinforcement Learning: Computational Modeling of Learning and Decision-Making.'' Lecture Notes of the Analytical Connectionism Summer School, PMLR Vol. 320. \vspace{2.5mm} \\
