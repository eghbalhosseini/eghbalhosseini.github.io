...
% Custom sort: year (descending) -> presort -> name -> title.
% Built-in templates put presort first, which causes role groups to span years.
\DeclareSortingTemplate{ydpt}{
...
\ExecuteBibliographyOptions{sorting=ydpt}
...
\mynames{Hosseini/Eghbal\bibnamedelima A, Hosseini*/Eghbal\bibnamedelima A, Hosseini†/Eghbal\bibnamedelima A}
...
\vspace{1mm} \
  ...
  \makefield{\faEnvelope[regular]}{\href{mailto:ehoseini@mit.edu}{\texttt{ehoseini@mit.edu}}}\hspace{2.5mm}\makefield{\faGlobe}{\url{https://eghbalhosseini.github.io}}

  %% Next line
  \makefield{\faLinkedin}{\href{https://www.linkedin.com/in/eghbalhosseini/}{\texttt{eghbalhosseini}\phantom{\texttt{xx}}}}\hspace{2.5mm}\makefield{\faGraduationCap}{\href{https://scholar.google.com/citations?user=r58bDGAAAAAJ&hl=en}{\texttt{Eghbal A. Hosseini}}}
